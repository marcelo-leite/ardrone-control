...
//      uint32_t nbsat;
      ...
      memcpy(&navdata.head, &incoming[0], sizeof(int32_t));
      // navdata.ardrone_state = *((int32_t*)&incoming[4]);
      memcpy(&navdata.ardrone_state, &incoming[4], sizeof(int32_t));
      // navdata.sequence = *((int32_t*)&incoming[8]);
      memcpy(&navdata.sequence, &incoming[8], sizeof(int32_t));
      // navdata.vision = *((int32_t*)&incoming[12]); 
      memcpy(&navdata.vision, &incoming[12], sizeof(int32_t));
      int len = 0;
      uint16_t k = 16;
      ...
      memcpy(&navdata.id, &incoming[16], sizeof(uint16_t));
      // navdata.siz = (uint16_t*)&incoming[18];
      memcpy(&navdata.siz, &incoming[18], sizeof(uint16_t));
      ...
      for(uint16_t i = 0; i < 28; i++){
        ...
        memcpy(&navdata.id, &incoming[0], sizeof(uint16_t));
        
        // navdata.siz = (uint16_t*)&block[2];
        memcpy(&navdata.siz, &incoming[2], sizeof(uint16_t));
        k += navdata.siz;
        ...
        switch (navdata.id){
          ...
          case 0:
            ...
            memcpy(&navdata.block.navdata_demo, &block[4], sizeof(navdata_demo_t));
            break;
          case 1:
            // navdata.block.navdata_time = *((navdata_time_t*)&block[4]);
            memcpy(&navdata.block.navdata_time, &block[4], sizeof(navdata_time_t));
            break;
          case 2:
            // navdata.block.navdata_raw_measures = *((navdata_raw_measures_t*)&block[4]);
            memcpy(&navdata.block.navdata_raw_measures, &block[4], sizeof(navdata_raw_measures_t));
            break;
          case 3:
            // navdata.block.navdata_phys_measures = *((navdata_phys_measures_t*)&block[4]);
            memcpy(&navdata.block.navdata_phys_measures, &block[4], sizeof(navdata_phys_measures_t));
            break;
          case 4:
            // navdata.block.navdata_gyros_offsets = *((navdata_gyros_offsets_t*)&block[4]);
            // memcpy(&navdata.block.navdata_magneto, &block[4], sizeof(navdata_magneto_t));
            break;
          case 5:
          ...
          case 9:
            ...
            memcpy(&navdata.block.navdata_pwm, &block[4], sizeof(navdata_pwm_t));
            break;
          case 10:
          ...
          case 20:
            ...
            // memcpy(&navdata.block.navdata_games , &block[4], sizeof(navdata_games_t));
            break;
          case 21:
            // navdata.block.navdata_pressure_raw = *((navdata_pressure_raw_t*)&block[4]);
            memcpy(&navdata.block.navdata_pressure_raw , &block[4], sizeof(navdata_pressure_raw_t));
            break;
          case 22:
          ...
          case 23:
            ...
            memcpy(&navdata.block.navdata_wind_speed, &block[4], sizeof(navdata_wind_speed_t));
            break;
          case 24:
            // navdata.block.navdata_kalman_pressure = *((navdata_kalman_pressure_t*)&block[4]);
            memcpy(&navdata.block.navdata_hdvideo_stream, &block[4], sizeof(navdata_hdvideo_stream_t));
            break;
          case 25:
          ...
          case 26:
            ...
            memcpy(&navdata.block.navdata_wifi, &block[4], sizeof(navdata_wifi_t));
            break;
          case 27:
