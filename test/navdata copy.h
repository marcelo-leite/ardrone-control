#ifndef NAVDATA_H   // guardas de cabeçalho, impedem inclusões cíclicas
#define NAVDATA_H
...
}_ATTRIBUTE_PACKED_ navdata_gps_channel;
...
typedef struct {
  ...
  float ehpe ;
  float ehve ;
  float c_n0; //Signal noise ratio (average of the four best satellites);
