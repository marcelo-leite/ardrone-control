...
//Function Member for connect with ARDrone v2.0
void ArdroneESP::ardroneConnect(void){
   // Connect to WiFi network
    ...
    while(this->NavUdp.parsePacket() == 0) {
      ...
      this->configCommand("control:altitude_max", "2000");
...
//Function Member to serialize AT command an send packet
...
//Function Member to send packet 
...
//Function Member capture flight data
void ArdroneESP::captureNavdata(void){
  ...
  this->ardata.fligth_data.phys_accs.x = this->navdata.block.navdata_phys_measures.phys_accs.x;
  this->ardata.fligth_data.phys_accs.y = this->navdata.block.navdata_phys_measures.phys_accs.y;
  this->ardata.fligth_data.phys_accs.z = this->navdata.block.navdata_phys_measures.phys_accs.z;

  this->ardata.fligth_data.magneto_raw.x = this->navdata.block.navdata_magneto.magneto_raw.x;
  this->ardata.fligth_data.magneto_raw.y = this->navdata.block.navdata_magneto.magneto_raw.y;
  this->ardata.fligth_data.magneto_raw.z = this->navdata.block.navdata_magneto.magneto_raw.z;
...
//Function Member Ref Command to perform actions (Takeoff, Land and Emergency mode)
...
//Function Member to perform actions for movement and hover
...
//Function Member Reset Comunication
...
//Function Member Control Led (BETA)
...
//Function Member to control pwm of quadrotor (Atention: Absolute Control)
...
//Function Member Changer config
...
void ArdroneESP::showNavdata(void){
  ...
  Serial.println(this->navdata.block.navdata_demo.vx);
  Serial.println(this->navdata.block.navdata_demo.vy);
  Serial.println(this->navdata.block.navdata_demo.vz);
  Serial.print("\n");
